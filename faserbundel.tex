...
Existiert jedoch ein Isomorphismus $F \to \mathbb{K}^n$, so gibt es immer Schnitte. \todo{Nullschnitt?} Ein solches Faserbündel nennen wir auf $\mathbb{K}$-Vektorbündel.}
